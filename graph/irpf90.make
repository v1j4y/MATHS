SRC += IRPF90_temp/irp_stack.irp.F90 IRPF90_temp/irp_touches.irp.F90 IRPF90_temp/plot.irp.F90 IRPF90_temp/plot.irp.module.F90
OBJ += IRPF90_temp/irp_stack.irp.o
OBJ1 = $(patsubst %, IRPF90_temp/%,$(notdir $(OBJ))) IRPF90_temp/irp_touches.irp.o 
ALL = plot
ALL_OBJ = plot.irp.module.o plot.irp.o
ALL_OBJ1 = $(patsubst %, IRPF90_temp/%,$(notdir $(ALL_OBJ)))
all:$(ALL)
	@$(MAKE) -s move
plot: IRPF90_temp/plot.irp.o IRPF90_temp/plot.irp.module.o $(OBJ1)
	$(FC) -o $@ IRPF90_temp/$@.irp.o IRPF90_temp/$@.irp.module.o $(OBJ1) $(LIB)
	@$(MAKE) -s move
IRPF90_temp/plot.irp.o: IRPF90_temp/plot.irp.module.o  
